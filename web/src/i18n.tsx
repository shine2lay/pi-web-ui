...
export const zh = {
	...
	setGlobalDefault: "☆ 设为全局默认（新项目自动使用）",
	clearGlobalDefault: "★ 取消全局默认",
	...
	theme: "主题",
	themeDefault: "深色（默认）",
	themeGroupClassics: "现代经典",
	themeGroupBuiltin: "原始预设",
	themeLight: "浅色",
	themeDark: "深色",
	newChat: "新对话",
	more: "更多",
	...
	openFiles: "文件列表",
	tldrTab: "TL;DR",
	tldrEmpty: "还没有 TL;DR。长任务里，agent 会在这里随手写一句进展（需要 pi-tldr 扩展）。",
	tldrShowAll: "显示全部（{n} 行）",
	tldrShowFewer: "收起",
	tldrNeedsYou: "需要你",
	/** tldr-collapse：看过的行折叠起来，连着的并成一行「N 行已读」。 */
	tldrCollapseAll: "全部折叠",
	tldrFoldLine: "折叠这一行（看过了）",
	tldrFolded: "{n} 行已读",
	tldrFoldedOne: "1 行已读",
	tldrUnfold: "重新展开这几行",
	/** queue-panel：右栏「队列」tab，pi-queue 的任务队列（计划透了、你批准了才进来）。 */
	taskQueueTab: "队列",
	taskQueueEmpty: "队列是空的。在对话里和 agent 把一个任务计划透，你批准了计划，它就排到这里（需要 pi-queue 扩展）。",
	taskQueueNotLoaded: "这条对话没有加载 pi-queue 扩展，队列不能开始。",
	taskQueueStart: "开始",
	taskQueueStartHint: "agent 按顺序一个接一个做排着的任务",
	taskQueueStop: "停下",
	taskQueueStopHint: "不再开始新任务；agent 手上这一步照常做完。要马上停，用对话的停止按钮。",
	taskQueueStatusStuck: "等你回答 #{id}",
	taskQueueStatusWorking: "在跑 · 正在做 #{id}",
	taskQueueStatusRunning: "在跑",
	taskQueueStatusStopped: "你停下了。按「开始」接着做。",
	taskQueueStatusRunStopped: "暂停了：这一轮被停了。",
	taskQueueStatusError: "暂停了：这一轮出错了。",
	taskQueueStatusRestart: "暂停了：pi 重启过。",
	taskQueueStatusIdle: "没在跑。按「开始」，agent 按顺序一个个做。",
	taskQueueStatusFinished: "都做完了。",
	taskQueueNow: "正在做",
	taskQueueNext: "排着",
	taskQueueDone: "做完了",
	...
	taskQueueUp: "往前挪",
	taskQueueDown: "往后挪",
	taskQueueRemove: "从队列删除",
	taskQueueRemoveAsk: "删除 #{id}？",
	taskQueueRemoveYes: "删除",
	taskQueuePlanToggle: "展开 / 收起计划",
	taskQueueGoal: "目标",
	taskQueueDoneWhen: "怎样算做完",
	taskQueueDecided: "和你一起定下的",
	taskQueueSteps: "步骤",
	taskQueueVerify: "怎么验收",
	taskQueueMustNot: "不做什么",
	taskQueueStarted: "{time} 开始",
	taskQueueFinishedAt: "{time} 做完",
	taskQueueShowAllDone: "显示全部做完的（{n} 个）",
	taskQueueShowFewer: "收起",
	taskQueueClearDone: "清除",
	taskQueueClearDoneHint: "把做完的任务从列表里清掉",
	openProject: "打开项目",
	streaming: "进行中…",
	noHistory: "还没有历史对话",
	current: "当前",
	...
	notifyDoneBodyChat: "「{title}」已完成，等待你的输入。",
	...
	"sound.done": "回复结束",
	"sound.done.desc": "任何一条对话里智能体完成一轮回答时",
	"sound.start": "回复开始",
	...
	foldTurnOne: "1 轮",
	foldThinking: "{n} 段思考",
	foldToolCalls: "{n} 次工具调用",
	foldToolCallOne: "1 次工具调用",
	foldWorking: "进行中",
	foldError: "出错",
	foldAborted: "已中止",
	foldStepThinking: "思考中…",
	foldStepWriting: "正在写回答…",
	foldShow: "展开这一轮的全部步骤",
	foldHide: "收起这一轮的步骤",
	...
	savingImage: "正在生成图片…",
	imageTitle: "标题",
	imageTitlePlaceholder: "可选，显示在图片顶部",
	imageBorder: "边框",
	imageWatermark: "水印",
	imageWatermarkPlaceholder: "水印文字",
	exportSelectHint: "勾选对话中的消息拼进图片（越早的越靠上）",
	exportTooLong: "选中内容太长，请减少条数后再复制",
	exportSelectedCount: "已选 {n} 条",
	exportIncludeTools: "包含工具调用",
	exportIncludeThinking: "包含思考过程",
	errorOutput: "错误输出",
	output: "输出",
	waitingOutput: "等待输出…",
	...
	scmNoHistory: "暂无提交记录",
	scmHistoryFilterPlaceholder: "过滤提交（主题 / 作者 / hash）…",
	scmHistoryFilterTip: "空格分隔多关键字（AND 语义）；匹配主题 / 作者 / hash / 分支·标签",
	scmHistoryFilterEmpty: "没有匹配的提交",
	scmCommitHistoryTip: "按 ↑/↓ 回溯最近用过的提交信息",
...
const en: Record<keyof typeof zh, string> = {
	...
	themeGroupClassics: "Classics",
	themeGroupBuiltin: "Original",
	themeLight: "Light",
	themeDark: "Dark",
	newChat: "New chat",
	more: "More",
	...
	openFiles: "Files",
	tldrTab: "TL;DR",
	tldrEmpty: "No TL;DR yet. During long runs the agent posts a short progress line here (needs the pi-tldr extension).",
	tldrShowAll: "Show all ({n} lines)",
	tldrShowFewer: "Show fewer",
	tldrNeedsYou: "Needs you",
	tldrCollapseAll: "Collapse all",
	tldrFoldLine: "Collapse this line (read)",
	tldrFolded: "{n} read lines",
	...
	taskQueueStatusStopped: "Stopped. Press Start to carry on.",
	taskQueueStatusRunStopped: "Paused: the run was stopped.",
	taskQueueStatusError: "Paused: the run hit an error.",
	taskQueueStatusRestart: "Paused: pi restarted.",
	taskQueueStatusIdle: "Not running. Press Start and the agent works through the queue.",
	taskQueueStatusFinished: "All done.",
	taskQueueNow: "Now",
	taskQueueNext: "Up next",
	taskQueueDone: "Done",
	taskQueueNeedsYou: "Needs you",
	taskQueueAnswerHint: "Answer in the chat and it carries on.",
	taskQueueUp: "Move up",
	taskQueueDown: "Move down",
	taskQueueRemove: "Remove from the queue",
	taskQueueRemoveAsk: "Remove #{id}?",
	taskQueueRemoveYes: "Remove",
	taskQueuePlanToggle: "Show or hide the plan",
	taskQueueGoal: "Goal",
	taskQueueDoneWhen: "Done when",
	taskQueueDecided: "Decided with you",
	taskQueueSteps: "Steps",
	taskQueueVerify: "Checked by",
	taskQueueMustNot: "Won't do",
	taskQueueStarted: "started {time}",
	taskQueueFinishedAt: "done {time}",
	taskQueueShowAllDone: "Show all done ({n})",
	...
	notifyDoneBodyChat: "“{title}” finished and is ready for your input.",
	...
	"sound.done.desc": "When the agent finishes a turn in any chat",
	...
	foldToolCalls: "{n} tool calls",
	foldToolCallOne: "1 tool call",
	foldWorking: "working",
	foldError: "error",
	foldAborted: "stopped",
	foldStepThinking: "thinking…",
	foldStepWriting: "writing the answer…",
	foldShow: "Show every step of this exchange",
	foldHide: "Fold this exchange's steps",
	...
	imageTitle: "Title",
	imageTitlePlaceholder: "Optional, shown at the top of the image",
	imageBorder: "Border",
	imageWatermark: "Watermark",
	imageWatermarkPlaceholder: "Watermark text",
	exportSelectHint: "Check messages in the chat to add them to the image (oldest at the top).",
	exportTooLong: "Selection is too long. Uncheck some messages and try again.",
	exportSelectedCount: "{n} selected",
	exportIncludeTools: "Include tool calls",
	exportIncludeThinking: "Include thinking",
	...
	scmHistoryFilterPlaceholder: "Filter commits (subject / author / hash)…",
	scmHistoryFilterTip: "Space separates keywords (AND); matches subject / author / hash / decorations",
	scmHistoryFilterEmpty: "No commits match the filter",
	scmCommitHistoryTip: "Press ↑/↓ to recall recent commit messages",
