...
export const zh = {
	...
	messages: "消息",
	pluginStatus: "插件状态",
	statusToPanel: "点一下收进右栏底部",
	statusToBar: "点一下钉到底栏（收起右栏也看得见）",
	engineBadge: "引擎",
	working: "工作中",
	queued: "排队",
...
const en: Record<keyof typeof zh, string> = {
	...
	statusToPanel: "Click to move it to the right panel",
	statusToBar: "Click to pin it to the status bar (stays visible with the panel closed)",
	engineBadge: "Engine",
	working: "Working",
	queued: "queued",
